...
void get_weather() {
  ...
  /*********************** 退出透传模式 *****************************ok*/
  printf(quit_transparent_transmission);
...
void update_time() {
  ...
  rtc_date.Year = timeinfo->tm_year - 100;
...
static chart_event_cb(lv_event_t* e) {
